  ...
  return (
    <div className="flex-none w-auto h-64 bg-secondary">
      ...
      <div className="flex justify-center h-60px">
        <button className="bg-white py-3 px-7 inline-flex items-center rounded-l-lg">
        ...
        <button className="bg-white py-3 px-7 inline-flex items-center">
        ...
        <button className="bg-gray-400 py-3 px-7 inline-flex items-center rounded-r-lg">
